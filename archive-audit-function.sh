...
echo "📚 Archiving get-audit-report Netlify Function"
echo "==============================================="
echo ""

# Create archive directory
mkdir -p archived/netlify-functions/get-audit-report

# Move the function
mv netlify/functions/get-audit-report/* archived/netlify-functions/get-audit-report/

# Remove empty directory
rmdir netlify/functions/get-audit-report

echo "✓ Archived to archived/netlify-functions/get-audit-report/"
echo ""

# Create migration doc
cat > archived/netlify-functions/get-audit-report/MIGRATION.md << 'MIGDOC'
...
echo ""
echo "Files archived:"
ls -la archived/netlify-functions/get-audit-report/
echo ""
