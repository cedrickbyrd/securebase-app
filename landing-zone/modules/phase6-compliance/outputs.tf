...
output "config_rule_arns" {
  ...
  value = {
    s3_ssl_requests_only    = aws_config_config_rule.s3_ssl_requests_only.arn
    ...
    mfa_iam_console         = aws_config_config_rule.mfa_iam_console.arn
    root_account_mfa        = aws_config_config_rule.root_account_mfa.arn
    cloudtrail_enabled      = aws_config_config_rule.cloudtrail_enabled.arn
    cloudtrail_log_valid    = aws_config_config_rule.cloudtrail_log_validation.arn
    vpc_flow_logs           = aws_config_config_rule.vpc_flow_logs.arn
    guardduty_enabled       = aws_config_config_rule.guardduty_enabled.arn
    s3_bucket_logging       = aws_config_config_rule.s3_bucket_logging.arn
    s3_bucket_versioning    = aws_config_config_rule.s3_bucket_versioning.arn
    s3_public_read_prohib   = aws_config_config_rule.s3_public_read_prohibited.arn
    s3_public_write_prohib  = aws_config_config_rule.s3_public_write_prohibited.arn
    iam_no_inline_policy    = aws_config_config_rule.iam_no_inline_policy.arn
    ...
    rds_no_public_access    = aws_config_config_rule.rds_public_access.arn
    rds_storage_encrypted   = aws_config_config_rule.rds_storage_encrypted.arn
    rds_multi_az            = aws_config_config_rule.rds_multi_az.arn
    lambda_no_public_access = aws_config_config_rule.lambda_no_public_access.arn
    api_gw_ssl              = aws_config_config_rule.api_gw_ssl.arn
    cloudwatch_alarm_action = aws_config_config_rule.cloudwatch_alarm_action.arn
    kms_not_scheduled_del   = aws_config_config_rule.kms_not_scheduled_deletion.arn
    secretsmanager_rotation = aws_config_config_rule.secretsmanager_rotation.arn
    ec2_imdsv2              = aws_config_config_rule.ec2_imdsv2.arn
    dynamodb_backup_plan    = aws_config_config_rule.dynamodb_backup_plan.arn
  }
}
