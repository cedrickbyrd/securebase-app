...
resource "aws_config_config_rule" "vpc_flow_logs" {
  ...
  description = "SOC2 CC8.1 / FedRAMP SC-7: VPC flow logs must be enabled"
  source {
    owner             = "AWS"
...
resource "aws_config_config_rule" "rds_multi_az" {
  ...
  description = "FedRAMP SI-2: RDS instances must have Multi-AZ enabled"
  source {
    owner             = "AWS"
...
resource "aws_config_config_rule" "ec2_imdsv2" {
  ...
  description = "FedRAMP CM-2: EC2 instances must use IMDSv2"
  source {
    owner             = "AWS"
...
resource "aws_config_config_rule" "dynamodb_backup_plan" {
  ...
  description = "SOC2: DynamoDB tables must be covered by a backup plan"
  source {
    owner             = "AWS"
...
# Use AWS-managed S3 sample templates
# ============================================================================
