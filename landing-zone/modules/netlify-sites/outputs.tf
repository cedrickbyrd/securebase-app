...
output "marketing_deploy_url" {
  ...
  value       = "https://${data.netlify_site.marketing.default_domain}"
}
...
output "portal_demo_url" {
  ...
  value       = data.netlify_site.portal_demo.default_domain
}
...
output "portal_demo_deploy_url" {
  ...
  value       = "https://${data.netlify_site.portal_demo.default_domain}"
}
...
output "deployment_summary" {
  ...
  value = {
    marketing_site = {
      netlify_url   = "https://${data.netlify_site.marketing.default_domain}"
      custom_domain = data.netlify_site.marketing.custom_domain
      site_id       = data.netlify_site.marketing.id
    }
    portal_demo = {
      netlify_url   = "https://${data.netlify_site.portal_demo.default_domain}"
