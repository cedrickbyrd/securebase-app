#!/bin/bash
# 🚀 SECUREBASE LIVE MODE - MANUAL SETUP COMMANDS
# Copy and paste these commands one by one

echo "🚀 SECUREBASE LIVE MODE SETUP"
echo "============================="
echo ""

# Prerequisites check
echo "📋 Step 1: Prerequisites"
echo "• Stripe account verified with business info"
echo "• Bank account connected for payouts"  
echo "• Live API keys ready (pk_live_... and sk_live_...)"
echo ""

# Install dependencies
echo "💻 Step 2: Install Portal Dependencies"
echo "cd phase3a-portal"
echo "npm install"
echo ""

# Stripe CLI setup (if not installed)
echo "🔧 Step 3: Install Stripe CLI (if needed)"
echo "# macOS:"
...
echo "🛍️  Step 4: Create Stripe Products (Run these with your live secret key)"
echo ""
...
echo "📝 Step 5: Update Portal Environment"
...
echo "🏗️  Step 6: Build & Deploy Portal"
echo "cd phase3a-portal"
echo "npm run build"
echo ""
...
echo "🎉 Step 9: Start Selling!"
echo "• Share signup URL with prospects"
echo "• Send LinkedIn messages and cold emails"
echo "• Book demo calls"
echo "• Monitor revenue in Stripe Dashboard"
echo ""
