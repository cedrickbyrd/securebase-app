...
const DELIVERABLES = [
  ...
  { icon: <CheckCircle className="w-5 h-5 text-green-400" />, label: 'Auto-enrolled in Standard tier ($1,000/mo pilot, 30-day free trial, $495 credited to first invoice)' },
];
...
const FAQS = [
  ...
  {
    q: 'How does the Standard tier enrollment work?',
    a: 'After payment, you are automatically enrolled in the Standard tier at the $1,000/mo pilot rate. Your Standard subscription includes a 30-day free trial — no billing until after your pilot period is complete. Your $495 fee is applied as a credit against your first Standard invoice, reducing your first month\'s charge.',
  },
  {
    q: 'Can I cancel the Standard subscription before billing starts?',
    a: 'Yes. You can cancel the Standard subscription at any time from the portal before the 30-day trial ends and you will not be charged. The $495 Compliance Jumpstart fee for the one-time deliverables is non-refundable.',
  },
  {
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-gray-900 font-sans">
      ...
      <main className="max-w-4xl mx-auto px-6 py-16">
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-8 mb-12 text-center max-w-lg mx-auto">
          ...
          <p className="text-blue-300 text-sm mb-6">One-time payment · Standard tier enrollment included</p>
          ...
          <div className="mt-4 flex flex-col gap-1.5">
            {[
              ...
              'Auto-enrolled in Standard tier ($1,000/mo pilot, 30-day free trial)',
              '$495 credited to your first Standard invoice',
            ].map((line) => (
