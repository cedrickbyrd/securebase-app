...
echo ""
echo "Next steps:"
echo "1. Deploy with Terraform: cd ../../../landing-zone/environments/dev && terraform apply"
echo "2. Test endpoint: curl https://[api-id].execute-api.us-east-1.amazonaws.com/prod/health"
