...
**Status:** FAILED
**Error:** Expected 200, got 000000000000
...
**Status:** WARNING
**Message:** Expected 401/403, got 000000000000 (may be mock mode)
...
**Status:** FAILED
**Error:** Expected 200/201, got 000000000000000000000
...
**Status:** FAILED
**Error:** Endpoint failed for period 7d (Status: 000000000000)

### ❌ Period parameter validation (30d)
**Status:** FAILED
**Error:** Endpoint failed for period 30d (Status: 000000000000)

### ❌ Period parameter validation (90d)
**Status:** FAILED
**Error:** Endpoint failed for period 90d (Status: 000000000000)

### ✅ Response time < 5s (performance)

### ⚠️ Invalid parameter handling
**Status:** WARNING
**Message:** Expected 400/422, got 000000000000 (may accept invalid params)

### ⚠️ Customer ID extraction from JWT
**Status:** WARNING
**Message:** Unexpected status: 000000000000

### ⚠️ Non-existent endpoint handling
**Status:** WARNING
**Message:** Expected 404, got 000000000000
...
**Status:** FAILED
**Error:** Report creation failed (Status: 000000000000000000000)
